...
const legacyWorkoutTemplates: WorkoutTemplate[] = [
  ...
  {
    meta: {
      id: "first-gym-starter-day",
      title: "第一次健身房 · 12分钟轻量启动",
      description:
        "给第一次来健身房的新手女生：熟悉器械区、体验推与拉的固定器械，轻松有氧收尾，建立安全感与完成感，不追求练累。",
      estimatedMinutes: 12,
      intensity: "低强度",
      focus: "熟悉器械、建立安全感",
      trainingType: "新手入门",
      equipmentSummary: "推胸机、高位下拉机、跑步机、椭圆机",
      cycleStatus: "not_period",
      energyLevel: "normal",
      targetArea: "full_body",
    },
    workoutByPhase: {
      warmup: [
        {
          id: "fg-starter-wu-shoulder-circles",
          mediaSearchQuery: "shoulder circles",
          name: "肩部绕环",
          phase: "warmup",
          sets: 1,
          ...
          duration: "30秒",
          equipment: "无需器械",
          visualPlaceholder: "fg-starter-wu-shoulder-circles-placeholder",
          equipmentGuide: {
            machineIntro: "徒手热身，放松肩颈与上背，适合进健身房前先让身体「醒过来」。",
            seatSetup: "无需座椅，站姿或坐姿均可。",
            postureSetup: "肩膀放松下沉，脊柱自然中立。",
            gripSetup: "双臂自然垂于体侧。",
            weightTip: "无需负重。",
          },
          actionGuide: {
            step1: "站直或坐直，双肩放松。",
            step2: "缓慢向前、向后画小圈，幅度以舒适为准。",
            step3: "保持匀速，不要甩动手臂。",
            breathing: "自然呼吸。",
          },
          commonMistakes: ["动作过快", "耸肩", "圈幅过大"],
          alternative: "单臂小幅画圈。",
        },
        {
          id: "fg-starter-wu-treadmill-walk",
          mediaSearchQuery: "walking treadmill",
          name: "跑步机慢速走",
          phase: "warmup",
          sets: 1,
          reps: "1分钟",
          duration: "1分钟",
          equipment: "跑步机",
          visualPlaceholder: "fg-starter-wu-treadmill-walk-placeholder",
          equipmentGuide: {
            machineIntro: "用跑步机慢走熟悉有氧区与器械环境，不追求出汗。",
            seatSetup: "站在跑带两侧上机，先扶扶手站稳再启动。",
            postureSetup: "抬头挺胸，肩放松，步幅小而稳。",
            gripSetup: "轻扶扶手即可，不要握死。",
            weightTip: "零坡度或极低坡度，速度保持能轻松说话。",
          },
          actionGuide: {
            step1: "从极慢速度开始，确认跑带平稳。",
            step2: "自然摆臂，脚底柔和落地。",
            step3: "1分钟后逐渐减速停下。",
            breathing: "均匀呼吸。",
          },
          commonMistakes: ["速度过快", "低头看手机", "松手前未减速"],
          alternative: "过道原地慢步走。",
        },
      ],
      strength: [
        {
          id: "fg-starter-st-chest-press",
          mediaSearchQuery: "machine chest press",
          name: "坐姿推胸机",
          phase: "strength",
          sets: 1,
          ...
          duration: "2分钟",
          equipment: "器械推胸机",
          visualPlaceholder: "fg-starter-st-chest-press-placeholder",
          equipmentGuide: {
            machineIntro: "固定轨迹推胸，帮助第一次感受「向前推」的发力路径。",
            seatSetup: "座椅高度调到把手约与胸口中线齐平。",
            postureSetup: "背部贴紧靠垫，双脚踩稳。",
            gripSetup: "全握把手，手腕保持中立。",
            weightTip: "选择器械最轻档位或空杆，以动作标准为准。",
          },
          actionGuide: {
            step1: "坐稳握把，肩胛轻轻后收下沉。",
            step2: "用胸口发力向前推，手肘不完全锁死。",
            step3: "缓慢回收至起点，感受胸肌参与。",
            breathing: "推出呼气，回收吸气。",
          },
          commonMistakes: ["耸肩", "腰离靠垫", "重量过重", "回收过快"],
          alternative: "墙面俯卧撑。",
        },
        {
          id: "fg-starter-st-lat-pulldown",
          mediaSearchQuery: "lat pulldown",
          name: "高位下拉",
          phase: "strength",
          sets: 1,
          ...
          duration: "2分钟",
          equipment: "高位下拉机",
          visualPlaceholder: "fg-starter-st-lat-pulldown-placeholder",
          equipmentGuide: {
            machineIntro: "常见背部器械，帮助第一次找到「背在发力」的感觉。",
            seatSetup: "坐稳，大腿上方压住固定垫，双脚平踩地。",
            postureSetup: "胸口微挺，脊柱中立，不要后仰猛拉。",
            gripSetup: "略宽于正肩握横杆。",
            weightTip: "使用最轻重量，能完成10次标准下拉即可。",
          },
          actionGuide: {
            step1: "先沉肩，再开始下拉。",
            step2: "把横杆拉向锁骨至胸口上方，肘向身体两侧后方。",
            step3: "控制还原，手臂接近伸直即可。",
            breathing: "下拉呼气，还原吸气。",
          },
          commonMistakes: ["用腰借力", "耸肩", "下拉幅度过小", "猛弹还原"],
          alternative: "弹力带辅助下拉。",
        },
      ],
      cardio: [
        {
          id: "fg-starter-ca-elliptical",
          mediaSearchQuery: "elliptical trainer",
          name: "椭圆仪",
          phase: "cardio",
          sets: 1,
          reps: "前2分钟轻松，最后1分钟略加快",
          duration: "3分钟",
          equipment: "椭圆机",
          visualPlaceholder: "fg-starter-ca-elliptical-placeholder",
          equipmentGuide: {
            machineIntro: "比跑步机更稳的低冲击有氧，适合新手建立节奏感。",
            seatSetup: "双脚踩稳踏板再上机。",
            postureSetup: "身体直立，目视前方，不趴在扶手上。",
            gripSetup: "轻握扶手，自然摆动。",
            weightTip: "前2分钟低阻力匀速，最后1分钟略提速但仍可说话。",
          },
          actionGuide: {
            step1: "前2分钟保持轻松匀速，熟悉踏板节奏。",
            step2: "最后1分钟略微加快，仍保持上身稳定。",
            step3: "结束前逐渐减速。",
            breathing: "保持均匀呼吸。",
          },
          commonMistakes: ["阻力过大", "身体左右晃", "最后1分钟冲刺过猛"],
          alternative: "固定自行车轻松骑行。",
        },
      ],
      stretch: [
        {
          id: "fg-starter-st-hamstring-stretch",
          mediaSearchQuery: "hamstring stretch",
          name: "大腿后侧拉伸",
          phase: "stretch",
          sets: 1,
          reps: "30秒",
          duration: "30秒",
          equipment: "墙面可扶",
          visualPlaceholder: "fg-starter-st-hamstring-stretch-placeholder",
          equipmentGuide: {
            machineIntro: "放松大腿后侧，训练后常用静态拉伸。",
            seatSetup: "站姿，可扶墙保持平衡。",
            postureSetup: "骨盆中立，微屈膝或直腿以舒适为准。",
            gripSetup: "扶墙稳定。",
            weightTip: "无痛牵拉即可。",
          },
          actionGuide: {
            step1: "扶墙站直，一腿前伸脚跟点地或微屈另一膝。",
            step2: "从髋部轻轻前倾，感受大腿后侧牵拉。",
            step3: "停留30秒，换边或双侧交替。",
            breathing: "缓慢呼吸。",
          },
          commonMistakes: ["圆背猛压", "弹震式拉伸", "牵拉疼痛仍坚持"],
          alternative: "坐姿前屈轻拉伸。",
        },
        {
          id: "fg-starter-st-seated-side-stretch",
          mediaSearchQuery: "seated side stretch yoga",
          name: "坐姿侧腰舒展",
          phase: "stretch",
          sets: 1,
          reps: "每侧30秒",
          duration: "1分钟",
          equipment: "瑜伽垫 / 地面",
          visualPlaceholder: "fg-starter-st-seated-side-stretch-placeholder",
          equipmentGuide: {
            machineIntro:
              "训练结束前的柔和收尾，像瑜伽课里的侧腰伸展，帮助放松体侧与呼吸，不追求幅度。",
            seatSetup: "坐于瑜伽垫或干净地面，臀部均匀压实。",
            postureSetup: "骨盆坐正，肋骨不外翻，肩颈自然放松。",
            gripSetup: "同侧手可轻扶大腿外侧或垫面，对侧手臂向上延展。",
            weightTip: "无需负重，以舒适牵拉为准，有轻微拉感即可。",
          },
          actionGuide: {
            step1: "简易坐姿或盘腿坐稳，骨盆正对前方，双肩放松。",
            step2: "一侧手臂向上举过耳边，身体向对侧轻柔侧弯，感受侧腰拉长。",
            step3: "停留约30秒，呼吸放松后缓慢还原，换另一侧重复。",
            breathing: "侧弯时缓慢呼气，还原吸气；全程不憋气。",
          },
          commonMistakes: [
            "身体前倾塌腰",
            "耸肩或扭脖子看手",
