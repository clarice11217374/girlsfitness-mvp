      ...
      warmup: [
        {
          ...
          duration: "30秒",
          equipment: "无需器械",
          visualPlaceholder: "fg-starter-shoulder-circles-placeholder",
          equipmentGuide: {
        ...
        },
        {
          ...
          duration: "1分钟",
          equipment: "跑步机",
          visualPlaceholder: "fg-starter-treadmill-walk-placeholder",
          equipmentGuide: {
      ...
      strength: [
        {
          ...
          duration: "2分钟",
          equipment: "器械推胸机",
          visualPlaceholder: "fg-starter-chest-press-placeholder",
          equipmentGuide: {
        ...
        },
        {
          ...
          duration: "2分钟",
          equipment: "高位下拉机",
          visualPlaceholder: "fg-starter-lat-pulldown-placeholder",
          equipmentGuide: {
      ...
      cardio: [
        {
          ...
          duration: "3分钟",
          equipment: "椭圆机",
          visualPlaceholder: "fg-starter-elliptical-placeholder",
          equipmentGuide: {
      ...
      stretch: [
        {
          ...
          duration: "30秒",
          equipment: "墙面可扶",
          visualPlaceholder: "fg-starter-hamstring-stretch-placeholder",
          equipmentGuide: {
        ...
        },
        {
          ...
          duration: "30秒",
          equipment: "墙面 / 门框",
          visualPlaceholder: "fg-starter-chest-opener-placeholder",
          equipmentGuide: {
            machineIntro: "打开胸口与肩前，缓解推类动作后的紧绷感。",
            seatSetup: "站在墙边或门框旁。",
            postureSetup: "身体直立，肩放松下沉。",
            gripSetup: "前臂或手掌扶墙。",
            weightTip: "温和拉伸，不拉痛感。",
          },
          actionGuide: {
            step1: "手臂扶墙，肘略高于肩或与肩平。",
            step2: "身体轻轻转向对侧，感受胸肩拉伸。",
            step3: "停留30秒，呼吸放松。",
            breathing: "保持缓慢呼吸。",
          },
          commonMistakes: ["扭转过度", "耸肩", "拉得太猛"],
          alternative: "双手背后轻交握打开胸口。",
        },
      ],
    },
  },
